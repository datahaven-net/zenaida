...
def test_domain_regenerate_from_csv_row_dry_run():
    ...
    assert domains.find('test-import-1.ai') is None
    assert domains.find('test-import-2.ai') is None
    assert users.find_account('test1@gmail.com') is None
    assert users.find_account('test2@gmail.com') is None
...
def test_domain_regenerate_from_csv_row():
    ...
    domain1 = domains.find('test-import-1.ai')
    user1 = users.find_account('test1@gmail.com')
    ...
    domain2 = domains.find('test-import-2.ai')
    user2 = users.find_account('test2@gmail.com')
